                        ...
                        <form action="{{route('product#create')}}" method="post" novalidate="novalidate"
                            ...
                            <div class="form-group">
                                ...
                                <input id="cc-pament" name="pizzaName" type="text"
                                    ...
                                    aria-invalid="false" value="{{old('pizzaName')}}"
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="pizzaDescription"
                                    class="form-control @error('pizzaDescription')is-invalid @enderror " cols="30"
                            ...
                            <div class="form-group">
                                ...
                                <input id="cc-pament" name="pizzaWaitingTime" type="number" class="form-control @error('pizzaWaitingTime')is-invalid @enderror"
                                    aria-required="true" aria-invalid="false" value="" placeholder="Enter Waiting Time">
                            ...
                            <div class="form-group">
                                ...
                                <input id="cc-pament" name="pizzaPrice" type="number" class="form-control @error('pizzaPrice')is-invalid @enderror"
                                    aria-required="true" aria-invalid="false" value="" placeholder="Enter Pizza Price">
                                    @error('pizzaPrice')
                                    <div class="invalid-feedback">
                                        <small class="text-danger">{{$message}}</small>
                                    </div>
